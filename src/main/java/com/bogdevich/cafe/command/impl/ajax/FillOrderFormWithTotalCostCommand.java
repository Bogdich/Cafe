...
public class FillOrderFormWithTotalCostCommand implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        AnswerWrapper<BigDecimal> answerWrapper = null;
        ...
        try {
            if (userIdOptional.isPresent()) {
                ...
                BigDecimal totalCost = dishService.getShoppingCartTotalCost(userID);
                answerWrapper = new AnswerWrapper<>(totalCost);
            } else {
                BigDecimal totalCost = dishService.getShoppingCartTotalCost(session);
                answerWrapper = new AnswerWrapper<>(totalCost);
            }
