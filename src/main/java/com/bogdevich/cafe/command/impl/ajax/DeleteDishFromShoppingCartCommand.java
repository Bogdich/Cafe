...
public class DeleteDishFromShoppingCartCommand implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (userIdOptional.isPresent()) {
                ...
                dishService.deleteDishFromShoppingCart(userID, dishID);
            } else {
                dishService.deleteDishFromShoppingCart(session, dishID);
            }
